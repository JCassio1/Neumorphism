...
//  skeumorphic project
//
//  Created by MR.Robot 💀 on 08/08/2020.
...
struct RectangleButton: View {
    ...
    var body: some View {
        Text("Button")
            ...
            .background(
                ZStack {
                    ...
                    RoundedRectangle(cornerRadius:16, style: .continuous)
                        .fill(
                            LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1)), Color.white]), startPoint: .leading, endPoint: .bottomTrailing)
                    )
                        .padding(2)
                        .blur(radius: 2)
                }
        ...
        ) //similar to background but floats outside instead of being clipped
